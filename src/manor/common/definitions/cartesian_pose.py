...
@attr.frozen
class CartesianPose(DefinitionBase):
    """
    Pose of the EE control point in world (or base) frame.
    ...
    def get_capnp_schema(cls) -> CapnpStructSchema:
        return load_versioned_schema("cartesian_pose.capnp").VersionedCartesianPose

    @classmethod
    @override
    def get_lcm_class(cls) -> type:
        return lcmt_cartesian_pose
    ...
    @override
    def to_lcm_message(self) -> lcmt_cartesian_pose:
        msg = lcmt_cartesian_pose()
