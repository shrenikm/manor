...
Three trims are supported in Manor:
    ...
    - PARALLEL_GRIPPER        : Lite6 with actuated parallel gripper, normal mounting
...
from manor.manipulators.manipulator_variant import IManipulatorVariant, register_variant_for
