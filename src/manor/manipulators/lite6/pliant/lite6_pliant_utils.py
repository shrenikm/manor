...
LITE6_PLIANT_MULTIPLEXER_PD_IP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_PD_IP_NAME
LITE6_PLIANT_MULTIPLEXER_VD_IP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_VD_IP_NAME
LITE6_PLIANT_MULTIPLEXER_GSD_IP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_GSD_IP_NAME

LITE6_PLIANT_MULTIPLEXER_SE_IP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_SE_IP_NAME

LITE6_PLIANT_MULTIPLEXER_SD_OP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_SD_OP_NAME
LITE6_PLIANT_MULTIPLEXER_PE_OP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_PE_OP_NAME
LITE6_PLIANT_MULTIPLEXER_VE_OP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_VE_OP_NAME
LITE6_PLIANT_MULTIPLEXER_GSE_OP_NAME = LITE6_PLIANT_MULTIPLEXER_PREFIX + LITE6_PLIANT_GSE_OP_NAME
...
def get_tuned_pid_gains_for_pliant_id_controller(
    ...
    if lite6_control_type == Lite6ControlType.VELOCITY:
        ...
        return PIDGains(
            ...
            kd=np.array([50.0, 50.0, 50.0, 75.0, 75.0, 75.0, 500.0, 500.0], dtype=np.float64),
        )
    else:
        # Has not been tuned for other control types.
        raise NotImplementedError(f"ID PID gains have not been tuned for control type {lite6_control_type}")
