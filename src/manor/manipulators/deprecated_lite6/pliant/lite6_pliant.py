...
from manor.manipulators.deprecated_lite6.utils.lite6_hardware_utils import Lite6HardwareInterface
from manor.manipulators.deprecated_lite6.utils.lite6_model_utils import (
    ...
    get_default_lite6_positions_vector,
)
...
def create_lite6_pliant_for_simulation(
    ...
    # Set the default starting positions (joint + gripper).
    main_plant.SetDefaultPositions(
        model_instance=lite6_model,
        q_instance=get_default_lite6_positions_vector(
            lite6_model_type=config.lite6_model_type,
        ),
    )
    ...
    # Set the default starting positions for the controller plant as well.
